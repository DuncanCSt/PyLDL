...
def fit_best_model(
    ...
    model_instance = load_best_model(model, dataset, fold, hyperparams=hps)
    history = LossHistory()
    model_instance.fit(
        X_train, D_train,
